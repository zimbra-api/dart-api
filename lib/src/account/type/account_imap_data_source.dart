...
class AccountImapDataSource extends AccountDataSource {
  AccountImapDataSource(
      {super.id,
      super.name,
      super.folderId,
      super.enabled,
