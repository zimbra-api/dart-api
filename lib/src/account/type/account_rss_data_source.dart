...
class AccountRssDataSource extends AccountDataSource {
  const AccountRssDataSource({
    super.id,
    super.name,
    super.folderId,
    super.isEnabled,
  ...
  factory AccountRssDataSource.fromMap(Map<String, dynamic> data) => AccountRssDataSource(
        id: data['id'],
        name: data['name'],
        folderId: data['l'],
