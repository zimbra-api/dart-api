...
class AccountApi extends Api {
  ...
  Future<CreateDistributionListResponse?> createDistributionList(
    String name, {
    bool? isDynamic,
  ...
  Future<GetDistributionListMembersResponse?> getDistributionListMembers(
    String dl, {
    int? limit,
    int? offset,
  }) {
  ...
  Future<GetDistributionListResponse?> getDistributionList(
    DistributionListSelector dl, {
    bool? needOwners,
    bool? needRights,
  }) {
  ...
  Future<ModifyWhiteBlackListResponse?> modifyWhiteBlackList({
    List<OpValue> whiteListEntries = const [],
    List<OpValue> blackListEntries = const [],
  }) {
    return invoke(
  ...
  Future<SubscribeDistributionListResponse?> subscribeDistributionList(
    DistributionListSelector dl, {
  ...
  Future<SyncGalResponse?> syncGal({
    String? token,
    String? galAccountId,
    bool? idOnly,
    bool? getCount,
