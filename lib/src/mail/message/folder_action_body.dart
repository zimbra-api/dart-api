...
class FolderActionBody extends SoapBody {
  FolderActionBody({
    FolderActionRequest? request,
    FolderActionResponse? response,
  }) : super(request: request, response: response);

  factory FolderActionBody.fromMap(
    Map<String, dynamic> data,
  ) =>
      FolderActionBody(
        response: data['FolderActionResponse'] != null
            ? FolderActionResponse.fromMap(
                data['FolderActionResponse'],
              )
            : null,
      );
