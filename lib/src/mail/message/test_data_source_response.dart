...
import '../type/test_data_source.dart';
...
class TestDataSourceResponse extends SoapResponse {
  ...
  factory TestDataSourceResponse.fromMap(
      ...
      TestDataSourceResponse(
        imapDataSources: (data['imap'] is Iterable)
            ? (data['imap'] as Iterable)
                .map<TestDataSource>(
                  (imap) => TestDataSource.fromMap(imap),
                )
        ...
        pop3DataSources: (data['pop3'] is Iterable)
            ? (data['pop3'] as Iterable)
                .map<TestDataSource>(
                  (pop3) => TestDataSource.fromMap(pop3),
                )
                .toList(growable: false)
            : const [],
        caldavDataSources: (data['caldav'] is Iterable)
            ? (data['caldav'] as Iterable)
                .map<TestDataSource>(
                  (caldav) => TestDataSource.fromMap(caldav),
                )
                .toList(growable: false)
            : const [],
        yabDataSources: (data['yab'] is Iterable)
            ? (data['yab'] as Iterable)
                .map<TestDataSource>(
                  (yab) => TestDataSource.fromMap(yab),
                )
                .toList(growable: false)
            : const [],
        rssDataSources: (data['rss'] is Iterable)
            ? (data['rss'] as Iterable)
                .map<TestDataSource>(
                  (rss) => TestDataSource.fromMap(rss),
                )
                .toList(growable: false)
            : const [],
        galDataSources: (data['gal'] is Iterable)
            ? (data['gal'] as Iterable)
                .map<TestDataSource>(
                  (gal) => TestDataSource.fromMap(gal),
                )
                .toList(growable: false)
            : const [],
        calDataSources: (data['cal'] is Iterable)
            ? (data['cal'] as Iterable)
                .map<TestDataSource>(
                  (cal) => TestDataSource.fromMap(cal),
                )
                .toList(growable: false)
            : const [],
        unknownDataSources: (data['unknown'] is Iterable)
            ? (data['unknown'] as Iterable)
                .map<TestDataSource>(
                  (unknown) => TestDataSource.fromMap(unknown),
                )
                .toList(growable: false)
            : const [],
      );
