...
import 'package:zimbra_api/src/mail/message/add_appointment_invite_request.dart';
import 'package:zimbra_api/src/mail/message/add_appointment_invite_envelope.dart';
...
void main() {
  ...
  group('Add appointment invite tests', (() {
    test('Add appointment invite request', (() {
      ...
      final dayOfMonth = faker.date.dateTime().day;
      final week = faker.randomGenerator.integer(4);
      final dayOfWeek = faker.date.dateTime().weekday;
    ...
    test('Add appointment invite response', (() {
      ...
      final response = envelope.body.response as AddAppointmentInviteResponse;
