...
import 'package:zimbra_api/src/mail/message/cancel_appointment_envelope.dart';
import 'package:zimbra_api/src/mail/message/cancel_appointment_request.dart';
...
void main() {
  ...
  group('Cancel appointment tests', (() {
    ...
    test('Cancel appointment response', (() {
      ...
      final envelope = CancelAppointmentEnvelope.fromJson(json);
