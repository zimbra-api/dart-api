...
import 'package:zimbra_api/src/mail/message/cancel_task_envelope.dart';
import 'package:zimbra_api/src/mail/message/cancel_task_request.dart';
...
void main() {
  ...
  group('Cancel task tests', (() {
    test('Cancel task request', (() {
