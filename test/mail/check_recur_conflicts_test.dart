...
void main() {
  ...
  group('Check recur conflicts tests', (() {
    test('Check recur conflicts request', (() {
      ...
      final allInstances = faker.randomGenerator.boolean();
      ...
      final request = CheckRecurConflictsRequest(
        startTime: startTime,
        endTime: endTime,
    ...
    test('Check recur conflicts response', (() {
      final name = faker.lorem.word();
      final startTime = faker.date.dateTime().millisecondsSinceEpoch;
