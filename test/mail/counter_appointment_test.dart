...
import 'package:zimbra_api/src/mail/message/counter_appointment_envelope.dart';
import 'package:zimbra_api/src/mail/message/counter_appointment_request.dart';
...
void main() {
  ...
  group('Counter appointment tests', (() {
    test('Counter appointment request', (() {
      ...
      final request = CounterAppointmentRequest(
        id: id,
