...
void main() {
  ...
  group('Create appointment exception tests', (() {
    test('Create appointment exception request', (() {
      ...
      final request = CreateAppointmentExceptionRequest(
        id: id,
    ...
    test('Create appointment exception response', (() {
      final id = faker.guid.guid();
      final uid = faker.guid.guid();
      final name = faker.lorem.word();
      ...
      final envelope = CreateAppointmentExceptionEnvelope.fromJson(json);
