...
import 'package:zimbra_api/src/mail/message/create_appointment_response.dart';
...
void main() {
  ...
  group('Create appointment tests', (() {
    ...
    test('Create appointment response', (() {
      ...
      final envelope = CreateAppointmentEnvelope.fromMap(data);
      final response = envelope.body.response as CreateAppointmentResponse;
