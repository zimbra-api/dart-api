...
import 'package:zimbra_api/src/mail/message/create_task_exception_envelope.dart';
import 'package:zimbra_api/src/mail/message/create_task_exception_request.dart';
import 'package:zimbra_api/src/mail/message/create_task_exception_response.dart';
...
void main() {
  ...
  group('Create task exception tests', (() {
    ...
    test('Create task exception response', (() {
      final id = faker.guid.guid();
      final uid = faker.guid.guid();
      final name = faker.lorem.word();
      ...
      final response = envelope.body.response as CreateTaskExceptionResponse;
