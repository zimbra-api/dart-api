...
import 'package:zimbra_api/src/mail/message/decline_counter_appointment_envelope.dart';
import 'package:zimbra_api/src/mail/message/decline_counter_appointment_request.dart';
...
void main() {
  ...
  group('Decline counter appointment tests', (() {
    test('Decline counter appointment request', (() {
      ...
      final request = DeclineCounterAppointmentRequest(
        msg: Msg(
    ...
    test('Decline counter appointment response', (() {
      final json = {
        'Body': {
      ...
      final envelope = DeclineCounterAppointmentEnvelope.fromJson(json);
