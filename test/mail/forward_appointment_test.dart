...
import 'package:zimbra_api/src/mail/message/forward_appointment_envelope.dart';
import 'package:zimbra_api/src/mail/message/forward_appointment_request.dart';
...
void main() {
  ...
  group('Forward appointment tests', (() {
    test('Forward appointment request', (() {
      ...
      final request = ForwardAppointmentRequest(
        id: id,
