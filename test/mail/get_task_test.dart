...
import 'package:zimbra_api/src/mail/message/get_task_envelope.dart';
import 'package:zimbra_api/src/mail/message/get_task_request.dart';
import 'package:zimbra_api/src/mail/message/get_task_response.dart';
...
void main() {
  ...
  group('Get task tests', (() {
    test('Get task request', (() {
    ...
    test('Get task response', (() {
      ...
      final response = envelope.body.response as GetTaskResponse;
