...
import 'package:zimbra_api/src/mail/message/modify_appointment_envelope.dart';
import 'package:zimbra_api/src/mail/message/modify_appointment_request.dart';
import 'package:zimbra_api/src/mail/message/modify_appointment_response.dart';
...
void main() {
  ...
  group('Modify appointment tests', (() {
    test('Modify appointment request', (() {
      ...
      final request = ModifyAppointmentRequest(
        id: id,
    ...
    test('Modify appointment response', (() {
      ...
      final envelope = ModifyAppointmentEnvelope.fromMap(data);
      final response = envelope.body.response as ModifyAppointmentResponse;
