...
import 'package:zimbra_api/src/mail/message/modify_outgoing_filter_rules_envelope.dart';
import 'package:zimbra_api/src/mail/message/modify_outgoing_filter_rules_request.dart';
...
void main() {
  ...
  group('Modify outgoing filter rules tests', (() {
    test('Modify outgoing filter rules request', (() {
      ...
      final request = ModifyOutgoingFilterRulesRequest([
        FilterRule(
          name,
          active,
    ...
    test('Modify outgoing filter rules resonse', (() {
      final json = {
        'Body': {
      ...
      final envelope = ModifyOutgoingFilterRulesEnvelope.fromJson(json);
