...
import 'package:zimbra_api/src/mail/message/send_invite_reply_envelope.dart';
import 'package:zimbra_api/src/mail/message/send_invite_reply_request.dart';
import 'package:zimbra_api/src/mail/message/send_invite_reply_response.dart';
...
void main() {
  ...
  group('Send invite reply tests', (() {
    test('Send invite reply request', (() {
      final id = faker.guid.guid();
      final componentNum = faker.randomGenerator.integer(100);
      final updateOrganizer = faker.randomGenerator.boolean();
      ...
      final request = SendInviteReplyRequest(
        id,
        componentNum,
        verb: VerbType.accept,
        updateOrganizer: updateOrganizer,
        identityId: identityId,
        exceptionId: DtTimeInfo(
          dateTime: dateString,
          timezone: timezone,
          utcTime: utcTime,
        ),
    ...
    test('Send invite reply response', (() {
      final id = faker.guid.guid();
      final calItemId = faker.guid.guid();
      final deprecatedApptId = faker.guid.guid();
      ...
      final response = envelope.body.response as SendInviteReplyResponse;
