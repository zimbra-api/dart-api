...
void main() {
  ...
  group('Set appointment tests', (() {
    test('Set appointment request', (() {
      ...
      final request = SetAppointmentRequest(
        flags: flags,
        tags: tags,
        tagNames: tagNames,
        folderId: folderId,
    ...
    test('Set appointment response', (() {
      ...
      final envelope = SetAppointmentEnvelope.fromJson(json);
      final response = envelope.setAppointmentBody.setAppointmentResponse!;
