...
void main() {
  ...
  group('Snooze calendar item alarm tests', (() {
    test('Snooze calendar item alarm request', (() {
      final id = faker.guid.guid();
      final snoozeUntil = faker.date.dateTime().millisecondsSinceEpoch;

      final request = SnoozeCalendarItemAlarmRequest(
        apptAlarms: [SnoozeAlarm(id, snoozeUntil)],
