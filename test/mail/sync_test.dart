...
void main() {
  ...
  group('Sync tests', (() {
    test('Sync request', (() {
      ...
      final calendarCutoff = faker.randomGenerator.integer(100);
      final msgCutoff = faker.randomGenerator.integer(100);
      final folderId = faker.guid.guid();
      final typedDeletes = faker.randomGenerator.boolean();
      final deleteLimit = faker.randomGenerator.integer(100);
      final changeLimit = faker.randomGenerator.integer(100);
